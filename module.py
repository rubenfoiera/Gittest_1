...
class Seminar(Module):
    ...
    def __init__(self, ects, title, grade, topic):
        super().__init__(ects, title, grade)
        self.topic = topic
...
class Thesis(Module):
    def __init__(self, ects, title, grade, topic, research_group):
        super().__init__(ects, title, grade)
        self.topic = topic
    ...
    def __str__(self):
        return "Bachelor Thesis on the topic: %s on %s in the research group %s." % (self.topic, self.title, self.research_group)
